...
parser.add_argument('--save_path', type=str, default='results/results_hk_90%_0.99.npy', help='save path')
parser.add_argument('--w_1', type=float, default=0.99, help='weight for the first term in TQA')
